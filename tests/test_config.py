...
class TestConfigSystem:
    ...
    def test_save_config(self):
        ...
        config = {"learning_rate": 0.001, "batch_size": 32, "device": "cpu"}
    ...
    def test_setup_config_defaults_only(self):
        ...
        default_config = {"learning_rate": 0.001, "batch_size": 32, "device": "auto"}
        ...
        with patch("utils.config.argparse.ArgumentParser") as mock_parser:
            ...
            expected_config.update({"resume": False, "debug": False})
    ...
    def test_setup_config_with_file(self):
        ...
        file_config = {"learning_rate": 0.002, "max_epochs": 100, "device": "cpu"}
    ...
    def test_setup_config_priority(self):
        ...
        file_config = {"learning_rate": 0.002, "batch_size": 16}
    ...
    def test_config_validation(self):
        ...
        with patch("builtins.open", mock_file):
            with patch("os.path.exists", return_value=True):  # Mock file exists
                with patch(
                    "json.load",
                    side_effect=json.JSONDecodeError("test", "invalid json", 0),
                ):
                    mock_args = SimpleNamespace(
                        config="config.json",
                        batch_size=None,
                    ...
                    with patch("utils.config.argparse.ArgumentParser") as mock_parser:
                        ...
                        assert not config["resume"]  # Boolean flags included
