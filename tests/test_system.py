...
def test_policy_comparison():
    ...
    simple_policy = SimpleCompressionPolicy(
        embedding_dim=768,
        context_window=5,
        hidden_dim=256
    )
    ...
    logger.info(f"Estimated speedup vs complex policy: ~3-5x")
...
def test_reward_improvements():
    ...
    logger.info(f"   Issues: Arbitrary coefficient, scale mismatch, no normalization")
...
def test_baseline_comparison():
    ...
    test_sequences = [
        ["the", "extraordinarily", "quick", "brown", "fox", "jumps", "over", "the", "incredibly", "lazy", "dog"],
        ["machine", "learning", "algorithms", "are", "a", "subset", "of", "artificial", "intelligence", "methods"],
