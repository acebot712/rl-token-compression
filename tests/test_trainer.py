...
class TestSimpleJointTrainer:
    ...
    def test_init(self, device):
        ...
        trainer = SimpleJointTrainer(policy_lr=1e-3, reconstructor_lr=1e-4, device=device, context_window=5)
    ...
    def test_deterministic_behavior(self, device, tokenizer, reconstructor, sample_data):
        ...
        trainer1 = SimpleJointTrainer(
            device=device,
            random_seed=42,
            micro_batch_size=2,
            gradient_accumulation_steps=2,
        )
        trainer2 = SimpleJointTrainer(
            device=device,
            random_seed=42,
            micro_batch_size=2,
            gradient_accumulation_steps=2,
    ...
    def test_save_checkpoint(self, device, tokenizer, reconstructor, tmp_path):
        ...
        expected_keys = {
            ...
            "reconstructor_optimizer_state_dict",
            "step",
            "epoch",
        }
